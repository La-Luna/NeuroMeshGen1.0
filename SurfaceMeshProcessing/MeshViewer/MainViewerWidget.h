...
protected:
	...
	virtual void OpenSwcGUI(const QString& fname);
	...
	void ShowSWCPoints(void);
	void ShowSWCLines(void);
	void ShowSWCCylinders(void);
	...
	void ShowGaussCurve(void);
	//void ShowMeanCurve(void);
