...
void MeshParamWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MeshParamWidget *_t = static_cast<MeshParamWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (MeshParamWidget::*_t)();
...
const QMetaObject MeshParamWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MeshParamWidget.data,
      qt_meta_data_MeshParamWidget,  qt_static_metacall, nullptr, nullptr}
};
